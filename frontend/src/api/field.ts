...
// 字段联动API
export function getFieldDependencies(params?: any) {
  return request({
    url: '/api/v1/field-dependencies',
    method: 'get',
    params,
  })
}

export function getFieldDependency(id: number) {
  return request({
    url: `/api/v1/field-dependencies/${id}`,
    method: 'get',
  })
}

export function createFieldDependency(data: any) {
  return request({
    url: '/api/v1/field-dependencies',
    method: 'post',
    data,
...
export function updateFieldDependency(id: number, data: any) {
  return request({
    url: `/api/v1/field-dependencies/${id}`,
    method: 'put',
    data,
...
export function deleteFieldDependency(id: number) {
  return request({
    url: `/api/v1/field-dependencies/${id}`,
    method: 'delete',
  })
